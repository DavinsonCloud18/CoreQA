...
export function ModuleList({ modules, sessionId }: { modules: any[], sessionId: string }) {
  ...
  if (!modules || modules.length === 0) {
    return (
      <div className="w-full h-32 flex items-center justify-center border-2 border-dashed border-white/20 rounded-2xl">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center text-indigo-300 group-hover:bg-indigo-500/20 transition-colors">
